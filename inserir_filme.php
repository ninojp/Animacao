...
try {
	$inserir=$conecta->query("INSERT INTO `filme` (`titulo_filme`, `s_titulo_filme`, `enredo_filme`, `duracao_filme`, `exibido`, `img_mini`, `anime_id_anime`, `tipo_id_tipo`, `categoria_id_cat`) 
