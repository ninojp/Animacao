...
try {
	$inserir=$conecta->query("INSERT INTO `ova` (`titulo_ova`, `s_titulo_ova`, `enredo_ova`, `n_episodio_ova`, `duracao_ova`, `exib_inicio`, `exib_fim`, `img_mini`, `anime_id_anime`, `tipo_id_tipo`) 
	VALUES ('$recebe_titulo_ova', '$recebe_subtitulo_ova', '$recebe_enredo_ova', '$recebe_n_episodios_ova', '$recebe_duracao_ova', '$recebe_exib_inicio_ova', '$recebe_exib_fim_ova', '$img_nome1', '$recebe_select_anime3', '$recebe_tipo_anime1')");
