...
try {
	$inserir=$conecta->query("INSERT INTO `ova` (`titulo_ova`, `s_titulo_ova`, `enredo_ova`, `n_episodio_ova`, `duracao_ova`, `exib_inicio`, `exib_fim`, `img_mini`, `anime_id_anime`, `tipo_id_tipo`, `categoria_id_cat`) 
