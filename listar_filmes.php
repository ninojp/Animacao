...
if (!empty($filme)) {
	...
	$query_filme = "SELECT seri.id_filme, seri.titulo_filme, seri.img_mini, ani.id_anime FROM filme AS seri LEFT JOIN anime AS ani ON ani.id_anime = seri.anime_id_anime ORDER BY titulo_filme ASC LIMIT $inicio, $qnt_result_pg";
