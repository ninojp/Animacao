...
?>
	...
	<main class="container">
		<div class="row text-center fundo_black_80"><!-- ROW da parte CENTRAL  -->
			<div class="col-xxl-10 col-xl-10 col-lg-10 container"><!-- COLUNA CENTRAL  -->
				...
				?>
                <!-- Exibir MENSAGENs nesta parte -  msgAlertespeciais  -->
				<div class="row text-center">
					<span id="msgAlertespeciais"></span>
				</div>
				<!-- Tentativa de listar os Especiais aqui - listar_especiais -->
				<div class="row text-center">
					<span class="listar_especiais"></span>
				</div>
	...
	?>
<script src="js/especiais.js"></script>
</body>
</html>