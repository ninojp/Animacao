...
try {
	$inserir=$conecta->query("INSERT INTO `anime` (`nome_anime`, `nome_completo_anime`, `descricao_anime`, `personagens`, `img_mini`, `autor_id_autor`) 
	VALUES ('$recebe_nome', '$recebe_nome_completo', '$recebe_descricao', '$recebe_personagens', '$img_nome1', '$recebe_id_autor')");
