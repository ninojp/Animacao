...
try {
	$inserir=$conecta->query("INSERT INTO `ona` (`titulo_ona`, `s_titulo_ona`, `enredo_ona`, `n_episodio_ona`, `duracao_ona`, `exib_inicio`, `exib_fim`, `img_mini`, `anime_id_anime`, `tipo_id_tipo`) 
	VALUES ('$recebe_titulo_ona', '$recebe_subtitulo_ona', '$recebe_enredo_ona', '$recebe_n_episodios_ona', '$recebe_duracao_ona', '$recebe_exib_inicio_ona', '$recebe_exib_fim_ona', '$img_nome1', '$recebe_select_anime5', '$recebe_tipo_anime4')");
