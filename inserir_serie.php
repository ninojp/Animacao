...
try {
	$inserir=$conecta->query("INSERT INTO `serie` (`titulo_serie`, `s_titulo_serie`, `enredo_serie`, `n_episodio_serie`, `duracao_serie`, `exib_inicio`, `exib_fim`, `img_mini`, `anime_id_anime`, `tipo_id_tipo`) 
	VALUES ('$recebe_titulo_serie', '$recebe_subtitulo_serie', '$recebe_enredo_serie', '$recebe_n_episodios', '$recebe_duracao_serie', '$recebe_exib_inicio_serie', '$recebe_exib_fim_serie', '$img_nome1', '$recebe_select_anime2', '$recebe_tipo_anime')");
