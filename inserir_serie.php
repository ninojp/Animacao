...
try {
	$inserir=$conecta->query("INSERT INTO `serie` (`titulo_serie`, `s_titulo_serie`, `enredo_serie`, `n_episodio_serie`, `duracao_serie`, `exib_inicio`, `exib_fim`, `img_mini`, `anime_id_anime`, `tipo_id_tipo`, `categoria_id_cat`) 
