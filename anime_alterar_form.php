...
<body>
<!-- Inclusão do arquivo NAVBAR.php  -->
<?php include 'navbar_top.php'; ?>
<!-- Bloco MAIN -> ROW -> CONTAINER -->
<main class="container border border-primary text-center">
<div class="row">
...
<!-- BLOCO PARA SELECIONAR AS IMAGENS POR ANIME: escolher o anime para visualizar as imagens deste FALTA FAZER--------------->
