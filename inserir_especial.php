...
try {
	$inserir=$conecta->query("INSERT INTO `especial` (`titulo_especial`, `s_titulo_especial`, `enredo_especial`, `n_episodio_especial`, `duracao_especial`, `exib_inicio`, `exib_fim`, `img_mini`, `anime_id_anime`, `tipo_id_tipo`, `categoria_id_cat`) 
