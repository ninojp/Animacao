...
try {
	$inserir=$conecta->query("INSERT INTO `especial` (`titulo_especial`, `s_titulo_especial`, `enredo_especial`, `n_episodio_especial`, `duracao_especial`, `exib_inicio`, `exib_fim`, `img_mini`, `anime_id_anime`, `tipo_id_tipo`) 
	VALUES ('$recebe_titulo_especial', '$recebe_subtitulo_especial', '$recebe_enredo_especial', '$recebe_n_episodios_especial', '$recebe_duracao_especial', '$recebe_exib_inicio_especial', '$recebe_exib_fim_especial', '$img_nome1', '$recebe_select_anime4', '$recebe_tipo_anime3')");
