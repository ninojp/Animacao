...
if (!empty($pagina)) {
	...
	$qnt_result_pg = 20; // Quantidade de registro por pagina
...
if (($result_anime) and ($result_anime->rowCount() != 0)){
	...
	$dados .= "<li class='menu_pag page-item'><a class='page-link' href='#' onclick='listarAnimes($quantidade_pg)'>Ultima</a></li>";
