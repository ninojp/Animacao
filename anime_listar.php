...
<!-- coluna do campo Busca por letras -->
	<div class="col-xxl-10 container">
		<div class="col-xxl-12">
			<div class="row  mt-2">
				<div class="col-xxl-12 nav nav-tabs">
					...
					<div class="nav-item px-1"><a class="nav-link px-2" href="">A</a></div> 
		...
		<div class="row text-center">
			...
			<div class="col-xxl-12">
				<h1>Dtudo - Pagina para LISTAR os animes para alterar </h1>
			</div>
			<div class="row">
				...
				<div  style="max-height:300px; max-width: 190px;">
					<img id="img_foto" style="height:100%;" src="imgs/anime/<?php echo $exibir['img_mini']; ?>" class="img-responsive">
					<h3><?php echo $exibir['nome_anime']; ?></h3>
				</div>
				</a>
					<a href="anime_alterar_form.php?id_anime=<?php echo $exibir['id_anime']; ?>" target="_blank">
						<button class="meu_btn"> Alterar </button>
				</a>
				</div>
				<?php } ?>
			</div>
...
<!-- MAIN -> DIV -> SIDEBAR - CAMPO de selecionar por genero ----------------->
	...
	<div class="row">
		...
		<div class="col-xxl-12" style="margin-top: 2rem;">
			...
			<img src="imgs/banner/wikipedia_mini.png">
			<img src="imgs/banner/wikipedia-logo-text-logo-branco_mini.png">
			</a>
		</div>
		<div class="col-xxl-12" style="margin-top: 2rem;">
